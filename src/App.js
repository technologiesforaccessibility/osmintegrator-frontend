...
/*
const busStopPointerBlackIcon = new Icon({
  iconUrl: require("./assets/bus_stop_icon_black.svg"),
  iconRetinaUrl: require("./assets/bus_stop_icon_black.svg"),
  iconAnchor: [5, 55],
  popupAnchor: [10, -44],
  iconSize: [25, 55],
  shadowUrl: "./assets/bus_stop_icon_black.svg",
  shadowSize: [68, 95],
  shadowAnchor: [20, 92]
});
*/
...
/*
let busStopPointerBlackIcon = new Icon({
  iconUrl: icon,
